    ...
    case WM_COMMAND:
        {
            ...
            case ID_TEST_JIT:
                Jit();
                break;
            case ID_TEST_ACCESSVIOLATION:
                AccessViolation();
                break;
            case ID_TEST_HIGHCPU:
                HighCpu();
                break;
            case ID_TEST_HEAPCORRUPTION:
                HeapCorruption();
                break;
            case ID_TEST_STACKOVERRUN:
                StackOverrun();
                break;
			case ID_TEST_HANDLELEAK:
				HandleLeak();
				break;
            case ID_TEST_DEADLOCK:
                DeadLock();
                break;
            case ID_TEST_MEMORYLEAK:
                MemoryLeak();
                break;
            default:
